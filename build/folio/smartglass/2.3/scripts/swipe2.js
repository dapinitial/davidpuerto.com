//callback fires at the beginning instead of the end of the swipe
window.Slider = function(element, options) {
  ...
  var _this = this;
  var delegate; //this is the delegate that gets sent messages about scrollPosition
  var bounceScroll = true;
...
Slider.prototype = {
  ...
  onTouchMove: function(e) {
    ...
    if (!this.isScrolling) {
  	...
  	if (this.index == 0 && this.deltaX > 0 && this.delegate != undefined)               // if first slide and sliding left
		{
			this.delegate.sliderCallbackMouseMove(this.deltaX);
		}
		if (this.deltaX > 0 && this.bounceScroll == true)
		{
	...
	if (!(this.bounceScroll == false && this.index == 0))
	{
  ...
  onTouchEnd: function(e) {
 	if (this.index == 0)
	{
	  this.delegate.sliderMouseUp(this.deltaX);
	}
