(function () {
    ...
    /* =Local Scroll
    -------------------------------------------------------------- */
    $('.hero, nav').localScroll({duration: 1000});

    $('.offset').localScroll({duration: 1000, offset: -100});
    ...
    /* =Skill Bars
    -------------------------------------------------------------- */
    // $('.bar-fill').waypoint({     handler: function() { $(this).each(function() {
    //             $(this).animate({ width: $(this).attr('data-percent') }, 1500);
    // });     },    offset: '95%' });
    ...
    $('.lightbox').magnificPopup({
        ...
        zoom: {
            ...
            opener: function (openerElement) {
                return openerElement.is('.atvImg')
                    ? openerElement
                    : openerElement.find('.atvImg');
            }
        }
    });
